...
function replaceMeta(html,product,data,sku,reviews){
  ...
  const breadcrumb={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:data.lang==="ar"?"الرئيسية":"Home",item:data.lang==="en"?`${SITE_URL}/en/`:`${SITE_URL}/`},{"@type":"ListItem",position:2,name:categoryLabel(category,data.lang)||category,item:catUrl},{"@type":"ListItem",position:3,name:data.name,item:data.canonical}]};
